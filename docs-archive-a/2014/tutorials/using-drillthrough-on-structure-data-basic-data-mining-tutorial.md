...
1.  在中 [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] ，于資料採礦設計師的 [**採礦模型**] 索引標籤上，以滑鼠右鍵按一下 [ **TM_Decision_Tree** ] 模型，然後選取 [**屬性**]。  
...
3.  將 [**背景**] 值變更為 `1` 。 這樣就只會顯示模型中與購買自行車的客戶相關的部分。  
