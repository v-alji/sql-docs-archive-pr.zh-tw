...
5.  取代下列項目：  
    ...
    ```  
     ...
     來源查詢會參考 [!INCLUDE[ssSampleDBDWobject](../includes/sssampledbdwobject-md.md)] IntermediateTutorial 範例專案中定義的資料來源。 它使用此資料來源來存取 view vTimeSerie。 此檢視包含要用於定型採礦模型的來源資料。 如果您不熟悉此專案或此視圖，請參閱[第2課：建立預測案例 &#40;中繼資料採礦教學課程&#41;](../../2014/tutorials/lesson-2-building-a-forecasting-scenario-intermediate-data-mining-tutorial.md)。  
...
7.  在 [**另存**新檔] 對話方塊中，流覽至適當的資料夾，並將檔案命名為 `ProcessForecastingAll.dmx` 。  
