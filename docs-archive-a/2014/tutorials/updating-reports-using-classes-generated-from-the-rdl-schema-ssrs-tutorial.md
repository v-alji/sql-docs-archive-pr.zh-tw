...
# <a name="updating-reports-using-classes-generated-from-the-rdl-schema-ssrs-tutorial"></a>使用 RDL 結構描述產生的類別更新報表 (SSRS 教學課程)
  本教學課程說明如何使用 XML 架構定義工具 ( # A0) 來產生類別，讓您以類別序列化和還原序列化報表定義檔案 ( .rdl 和 .rdlc) 。 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] <xref:System.Xml.Serialization.XmlSerializer>  
