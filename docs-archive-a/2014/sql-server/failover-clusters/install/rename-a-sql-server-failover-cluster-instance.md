 ...
 ** [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] ：** 在您 [!INCLUDE[ssASCurrent](../../../includes/ssascurrent-md.md)] 使用 Windows 叢集系統管理員工具來變更容錯移轉叢集實例的網路名稱之後，未來的升級或卸載作業可能會失敗。 若要解決此問題，請遵循[此](https://go.microsoft.com/fwlink/?LinkId=244002) (的解決方式一節中的指示，更新**ClusterName**登錄專案 https://go.microsoft.com/fwlink/?LinkId=244002) 。  
