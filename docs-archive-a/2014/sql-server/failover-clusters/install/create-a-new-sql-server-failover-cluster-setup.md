...
21. 使用 [!INCLUDE[ssDE](../../../includes/ssde-md.md)] [組態 - FILESTREAM] 頁面來針對 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]執行個體啟用 FILESTREAM。 如需 FILESTREAM 的詳細資訊，請參閱 [Database Engine 組態 - Filestream](../../install/database-engine-configuration-filestream.md)。 選取 [下一步] 以繼續操作。  
...
16. 使用 [**伺服器設定-定序**] 索引標籤，為和指定非預設的定序 [!INCLUDE[ssDE](../../../includes/ssde-md.md)] [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] 。 如需詳細資訊，請參閱[伺服器組態 - 定序](../../install/server-configuration-collation.md)。  
  
17. 使用 [Server Configuration - Filestream (伺服器組態 - Filestream)]**[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 可針對 ** 的執行個體啟用 FILESTREAM。 如需詳細資訊，請參閱 [Database Engine 組態 - Filestream](../../install/database-engine-configuration-filestream.md)。 選取 [下一步] 以繼續操作。  
