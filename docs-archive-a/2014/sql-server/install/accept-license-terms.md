...
-   導致錯誤之處理序的記憶體或檔案中的資訊。  
 ...
 在安裝程式完成之後，若要對 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的所有執行個體及其元件停用錯誤或功能使用方式報表，請到 **[錯誤和使用方式報表設定]** 對話方塊，清除 **[功能使用方式]** 的核取方塊。 如果已針對 (、、和共用元件的多個元件啟用**錯誤報表**， [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]) 您可以停用個別元件的每個實例和共用元件的錯誤報表（列為**其他**元件）。  
