...
-   用於安裝 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的帳戶應該具有 SMB 檔案伺服器的 SeSecurityPrivilege 權限。 若要授與此許可權，請使用檔案伺服器上的 [本機安全性原則] 主控台，將 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 安裝程式帳戶新增至 [管理] [**審核及安全性記錄檔**] 原則。 在 [**本機安全性原則**] 主控台中 [**本機原則**] 下的 [**使用者權限指派**] 區段中，可以找到此設定。  
