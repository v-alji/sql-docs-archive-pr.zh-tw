...
-   有 Azure 帳戶嗎？  然後前往**[這裡](https://ms.portal.azure.com/?flight=1#create/Microsoft.SQLServer2016RTMEnterpriseWindowsServer2012R2)** 來啟動已安裝 SQL Server 2014 Service Pack 1 (SP1) 的虛擬機器。 如需 SQL Server 2014 (SP1) 的詳細資訊，請參閱[SQL Server 2014 Service Pack 1 版本資訊](https://support.microsoft.com/kb/3058865)。  
