...
##  <a name="upgrade-without-database-engine-upgrade"></a><a name="noengine"></a> 升級但不包含 Database Engine 升級  
 ...
 如果您選擇在 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 同一部電腦上安裝和舊版 SQL Server ([!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] / [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]) ，您可以這樣做，因為檔案會安裝在不同的位置。  
