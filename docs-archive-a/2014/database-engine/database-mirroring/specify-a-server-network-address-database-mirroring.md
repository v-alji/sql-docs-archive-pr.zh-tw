...
-   *\<port>* 是夥伴伺服器執行個體鏡像端點所使用的連接埠號碼。 如需指定端點的資訊，請參閱 [建立 Windows 驗證的資料庫鏡像端點 &#40;Transact-SQL&#41;](create-a-database-mirroring-endpoint-for-windows-authentication-transact-sql.md)。  
