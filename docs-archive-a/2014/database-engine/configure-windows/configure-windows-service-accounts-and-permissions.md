...
-   **[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]**-提供商業智慧應用程式 (OLAP) 和資料採礦功能的線上分析處理。 可執行檔為 \<MSSQLPATH>\OLAP\Bin\msmdsrv.exe。  
