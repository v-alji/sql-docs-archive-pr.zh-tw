...
||  
|-|  
|**適用**于： [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 透過[目前版本](https://go.microsoft.com/fwlink/p/?LinkId=299658)) 的 ([!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)] 。|  
