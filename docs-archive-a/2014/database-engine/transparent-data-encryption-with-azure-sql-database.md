...
||
|-|
|**適用**于： [!INCLUDE[sqldbesa](../includes/sqldbesa-md.md)] [某些區域中的 (預覽](https://azure.microsoft.com/documentation/articles/sql-database-preview-whats-new/?WT.mc_id=TSQL_GetItTag)) 。|
