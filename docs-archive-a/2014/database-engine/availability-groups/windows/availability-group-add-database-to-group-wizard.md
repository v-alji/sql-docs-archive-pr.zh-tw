...
##  <a name="using-the-add-database-to-availability-group-wizard-sql-server-management-studio"></a><a name="SSMSProcedure"></a>使用 [將資料庫加入至可用性組嚮導] (SQL Server Management Studio)   
 **使用將資料庫加入至可用性群組精靈**  
