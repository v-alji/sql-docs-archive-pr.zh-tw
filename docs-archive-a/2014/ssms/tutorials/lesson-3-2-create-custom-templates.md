...
11.  (步驟 7) 中的腳本編輯範本腳本，並在四個位置以參數<strong> *<* product_name</strong>、 `nvarchar(50)` 、 <strong> *>* 名稱</strong>取代 [產品名稱] 分葉。  
...
4.  在 [**取代範本參數**] 對話方塊中，針對 [ `product_name` 值] 輸入**FreeWheel** (覆寫) 的預設內容，然後按一下 **[確定]** 關閉 [**取代範本參數**] 對話方塊，並在 [查詢編輯器] 中修改腳本。  
