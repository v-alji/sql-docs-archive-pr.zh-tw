...
|圖示|可移動項目|
|----------|-------------------|
|![報表圖示](../media/hlp-16doc.gif "報表圖示")|報告|
...
|@ (at 符號)|[at]|使用者*名稱* @hotmail.com變成*username*[at] hotmail .com|
|& (連字號)|[amp]|使用者*名稱* @*公司* &*company.com*會變成*username*[at]*company*[amp]*company.com*|
|$ (貨幣符號)|[dollar]|*使用者*  $*Name*會變成*User*[] [美元]*名稱*|
