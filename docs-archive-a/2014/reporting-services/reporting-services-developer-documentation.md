...
## <a name="in-this-section"></a>本節內容  
 ...
 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 的模組化架構是針對擴充性所設計。 現在可以使用 Managed 程式碼 API，這樣您就可以輕鬆地開發、安裝和管理許多 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 元件取用的延伸模組。 您可以使用建立元件， [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] 並加入新的轉譯 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 、安全性、傳遞和資料處理功能，以滿足不斷演進的商務需求。  
