...
-   至於包含地圖的教學課程，報表伺服器必須設定為支援 Bing Maps 做為背景。 如需詳細資訊， [Plan for Map Report Support](plan-for-map-report-support.md)請參閱 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Msdn.microsoft.com 上《[線上叢書》](https://go.microsoft.com/fwlink/?LinkId=154888)中檔集的地圖報表支援規劃。  
