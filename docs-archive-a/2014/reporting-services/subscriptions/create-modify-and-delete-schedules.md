...
-   [ (SharePoint 模式建立和管理共用排程) ](#bkmk_sharepoint)  
...
##  <a name="create-and-manage-shared-schedules-sharepoint-mode"></a><a name="bkmk_sharepoint"></a> (SharePoint 模式建立和管理共用排程)   
...
##  <a name="create-and-manage-shared-schedules-native-mode"></a><a name="bkmk_native"></a> (原生模式建立和管理共用排程)   
