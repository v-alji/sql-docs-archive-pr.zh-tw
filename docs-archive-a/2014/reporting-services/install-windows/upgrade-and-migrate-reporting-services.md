...
4.  安裝程式會針對 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 程式檔建立新的資料夾。 安裝的程式資料夾 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 包括 MSRS12。 \<*instance name*>
...
8.  安裝程式會將報表伺服器資料庫升級到新的結構描述，並修改 `RSExecRole` (方式是將資料庫擁有者權限加入該角色)。 只有當您從 SP1 之前升級時，才會發生此步驟 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 。
...
##  <a name="sharepoint-mode-upgrade-and-migration-scenarios"></a><a name="bkmk_sharePoint_scenarios"></a> SharePoint 模式升級和移轉狀況
 下列各節描述從指定版本的 sharepoint 模式升級或遷移 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 至 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] SharePoint 模式時，所需的問題和基本步驟 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 。
...
### <a name="sssql11-to-sssql14"></a>按 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 移至 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]
...
### <a name="sskilimanjaro-to-sssql14"></a>按 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] 移至 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]
