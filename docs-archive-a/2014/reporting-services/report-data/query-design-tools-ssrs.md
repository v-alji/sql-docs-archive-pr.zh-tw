---
title: 報表設計師 SQL Server Data Tools (SSRS) 中的查詢設計工具 |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
##  <a name="text-based-query-designer"></a><a name="Textbased"></a>以文字為基礎的查詢設計工具
 以文字為基礎的查詢設計工具是最支援的關聯式資料來源的預設查詢建立工具，包括 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 、Oracle、Teradata、OLE DB、XML 和 ODBC。 相較於圖形化查詢設計工具，此查詢設計工具在查詢設計期間並不會驗證查詢語法。 下圖說明以文字為基礎的查詢設計工具。
