...
## <a name="file-location"></a>檔案位置  
 Rskeymgmt.exe 位於** \<*drive*> ： \PROGRAM Files\Microsoft sql Server\110\Tools\Binn**或 At ** \<*drive*> ： \Program FILES (x86) \microsoft sql Server\110\Tools\Binn**。 您可以從檔案系統上的任何資料夾執行此公用程式。  
