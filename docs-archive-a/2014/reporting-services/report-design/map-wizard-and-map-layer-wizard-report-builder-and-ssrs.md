...
###  <a name="what-is-an-esri-shapefile"></a><a name="Shapefile"></a>什麼是 ESRI 形狀檔？
 ESRI 形狀檔是一組檔案，其中包含符合 Environmental Systems Research Institute, Inc. (ESRI) 形狀檔空間資料格式的資料。 這組檔案通常包含 .shp 檔案， *\<filename>* 其中包含空間資料和支援檔案 *\<filename>* .dbf。
