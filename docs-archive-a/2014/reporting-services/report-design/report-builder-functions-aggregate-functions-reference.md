...
|主體|是<br /><br /> 附註 2|是|只有目前範圍或包含範圍內的項目<br /><br /> 附註 3|否|是|是|是|  
...
|內容|RunningValue|RowNumber|First<br /><br /> Last|上一個|Sum 和其他 Presort 函數|ReportItem 彙總|查閱函數|彙總函式|  
|-------------|------------------|---------------|--------------------|--------------|-------------------------------------|---------------------------|----------------------|------------------------|  
...
|**Function**|**說明**|  
|------------------|---------------------|  
|[First](report-builder-functions-first-function.md)|傳回所指定運算式給定範圍中的第一個值。|  
...
|**Function**|**說明**|  
|------------------|---------------------|  
|[彙總](report-builder-functions-aggregate-function.md)|傳回指定之運算式的自訂彙總，由資料提供者定義。|  
