...
5.  針對為延伸模組授與 `FullTrust` 權限的自訂組件，加入程式碼群組。 若要這麼做，您可以將程式碼群組新增至 rssrvpolicy.config 檔案，該檔案預設位於%ProgramFiles%\Microsoft SQL Server \\<MSRS10_50 中。 \<*Instance Name*>\Reporting Services\reportserver。 您的程式碼群組可能如下所示：  
