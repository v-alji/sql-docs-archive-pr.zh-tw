...
> [!IMPORTANT]  
>  從開始 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] ， *IsSharePointMode* = `True` 不支援 IsSharePointMode，因為在 sharepoint 模式中， [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 是 sharepoint 共用服務，且不受 WMI 提供者控制。 您應該一律將此參數設定為 `False`。  
