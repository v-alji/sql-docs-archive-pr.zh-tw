...
ms.locfileid: "87707473"
---
# <a name="use-table-valued-parameters-ole-db"></a><span data-ttu-id="57954-102">使用資料表值參數 (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="57954-102">Use Table-Valued Parameters (OLE DB)</span></span>
  <span data-ttu-id="57954-103">此範例適用於 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 或更新版本。</span><span class="sxs-lookup"><span data-stu-id="57954-103">This sample works with [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] or later.</span></span> <span data-ttu-id="57954-104">此範例會執行下列動作：</span><span class="sxs-lookup"><span data-stu-id="57954-104">This sample does the following:</span></span>  
  
-   <span data-ttu-id="57954-105">使用動態探索，透過 IOpenRowset::OpenRowset 建立資料表值參數。</span><span class="sxs-lookup"><span data-stu-id="57954-105">Creates table-valued parameters by using dynamic discovery though IOpenRowset::OpenRowset.</span></span>  
  
-   <span data-ttu-id="57954-106">使用 EmployeesRowset 類別中的提取模型，傳送資料表值參數資料列。</span><span class="sxs-lookup"><span data-stu-id="57954-106">Sends table-valued parameter rows by using the pull model in the EmployeesRowset class.</span></span> <span data-ttu-id="57954-107">在提取模型中，取用者會視需要提供資料給提供者。</span><span class="sxs-lookup"><span data-stu-id="57954-107">In the pull model, the consumer provides data on demand to the provider.</span></span>  
  
-   <span data-ttu-id="57954-108">將 BLOB 當做 CPhotograph 類別中之資料表值參數的一部分傳送。</span><span class="sxs-lookup"><span data-stu-id="57954-108">Sends BLOBs as part of a table-valued parameter in the CPhotograph class.</span></span>  
  
-   <span data-ttu-id="57954-109">利用 ISSCommandWithParameters 使用自訂參數屬性。</span><span class="sxs-lookup"><span data-stu-id="57954-109">Uses custom parameter properties using ISSCommandWithParameters.</span></span>  
  
-   <span data-ttu-id="57954-110">顯示 SQLNCLI11 錯誤的錯誤處理。</span><span class="sxs-lookup"><span data-stu-id="57954-110">Shows error handling for SQLNCLI11 errors.</span></span>  
  
 <span data-ttu-id="57954-111">如需資料表值參數的詳細資訊，請參閱[資料表值參數 &#40;SQL Server Native Client&#41;](../native-client/features/table-valued-parameters-sql-server-native-client.md)。</span><span class="sxs-lookup"><span data-stu-id="57954-111">For more information about table-valued parameters, see [Table-Valued Parameters &#40;SQL Server Native Client&#41;](../native-client/features/table-valued-parameters-sql-server-native-client.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="57954-112">範例</span><span class="sxs-lookup"><span data-stu-id="57954-112">Example</span></span>  
 <span data-ttu-id="57954-113">第一個 ([!INCLUDE[tsql](../../includes/tsql-md.md)]) 程式碼清單會建立此範例所使用的資料庫。</span><span class="sxs-lookup"><span data-stu-id="57954-113">The first ([!INCLUDE[tsql](../../includes/tsql-md.md)]) code listing creates the database used by the sample.</span></span>  
  
 <span data-ttu-id="57954-114">將第二個程式碼清單放入名為 stdafx.h 的檔案中。</span><span class="sxs-lookup"><span data-stu-id="57954-114">Put the second code listing into a file called stdafx.h.</span></span>  
  
 <span data-ttu-id="57954-115">將第三個程式碼清單放入名為 OLEDBUtils.hpp 的檔案中。</span><span class="sxs-lookup"><span data-stu-id="57954-115">Put the third code listing into a file called OLEDBUtils.hpp.</span></span>  
  
 <span data-ttu-id="57954-116">使用 ole32.lib oleaut32.lib 編譯並執行第四個 (C++) 程式碼清單。</span><span class="sxs-lookup"><span data-stu-id="57954-116">Compile with ole32.lib oleaut32.lib and execute the fourth (C++) code listing.</span></span> <span data-ttu-id="57954-117">這個應用程式會連接到電腦的預設 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 執行個體。</span><span class="sxs-lookup"><span data-stu-id="57954-117">This application connects to your computer's default [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="57954-118">在某些 Windows 作業系統上，您必須將 (localhost) 或 (local) 變更為 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 執行個體的名稱。</span><span class="sxs-lookup"><span data-stu-id="57954-118">On some Windows operating systems, you will need to change (localhost) or (local) to the name of your [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="57954-119">若要連線到具名執行個體，請將連接字串從 L"(local)" 變更為 L"(local)\\\name"，其中 name 是具名執行個體。</span><span class="sxs-lookup"><span data-stu-id="57954-119">To connect to a named instance, change the connection string from L"(local)" to L"(local)\\\name" , where name is the named instance.</span></span> <span data-ttu-id="57954-120">根據預設，[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express 會安裝至具名執行個體。</span><span class="sxs-lookup"><span data-stu-id="57954-120">By default, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Express installs to a named instance.</span></span> <span data-ttu-id="57954-121">請確認您的 INCLUDE 環境變數包含的目錄內含 sqlncli.h。</span><span class="sxs-lookup"><span data-stu-id="57954-121">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="57954-122">第五個 ([!INCLUDE[tsql](../../includes/tsql-md.md)]) 程式碼清單會建立此範例所使用的資料庫。</span><span class="sxs-lookup"><span data-stu-id="57954-122">The fifth ([!INCLUDE[tsql](../../includes/tsql-md.md)]) code listing creates the database used by the sample.</span></span>  
