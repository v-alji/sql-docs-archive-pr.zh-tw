...
ms.locfileid: "87709277"
---
# <a name="streaming-support-for-blob-output-parameters"></a><span data-ttu-id="bb32e-102">BLOB 輸出參數的串流支援</span><span class="sxs-lookup"><span data-stu-id="bb32e-102">Streaming Support for BLOB Output Parameters</span></span>
  <span data-ttu-id="bb32e-103">本主題包含的範例會示範 BLOB 輸出參數的串流支援，將 BLOB 輸出參數繫結為 IsequentialStreams。</span><span class="sxs-lookup"><span data-stu-id="bb32e-103">This topic contains a sample that shows streaming support for BLOB output parameters, which binds BLOB output parameters as ISequentialStreams.</span></span>  
  
 <span data-ttu-id="bb32e-104">您可能會在 IMultipleResults::GetResult 的輸出參數上遭到封鎖，並收到 DB_E_OBJECTOPEN 傳回值。</span><span class="sxs-lookup"><span data-stu-id="bb32e-104">You can become blocked on output parameters in IMultipleResults::GetResult, receiving DB_E_OBJECTOPEN return value.</span></span> <span data-ttu-id="bb32e-105">呼叫端應該檢查暫止的 blob 參數，並完整讀取它們或釋放它們。</span><span class="sxs-lookup"><span data-stu-id="bb32e-105">The caller should to check for pending blob parameters, and either read them completely or release them.</span></span>  
  
## <a name="example"></a><span data-ttu-id="bb32e-106">範例</span><span class="sxs-lookup"><span data-stu-id="bb32e-106">Example</span></span>  
  
### <a name="code"></a><span data-ttu-id="bb32e-107">程式碼</span><span class="sxs-lookup"><span data-stu-id="bb32e-107">Code</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="bb32e-108">另請參閱</span><span class="sxs-lookup"><span data-stu-id="bb32e-108">See Also</span></span>  
 [<span data-ttu-id="bb32e-109">BLOB 與 OLE 物件</span><span class="sxs-lookup"><span data-stu-id="bb32e-109">BLOBs and OLE Objects</span></span>](blobs-and-ole-objects.md)  
