...
###  <a name="specifying-a-backup-file-by-using-its-physical-name-transact-sql"></a><a name="BackupFileUsingPhysicalName"></a>使用 (Transact-sql 的機構名稱來指定備份檔案)   
...
-   [ (Transact-sql) 的磁帶特定備份和還原選項](#TapeOptions)  
...
###  <a name="specifying-a-backup-tape-by-using-its-physical-name-transact-sql"></a><a name="BackupTapeUsingPhysicalName"></a>使用 (Transact-sql 的機構名稱來指定備份磁帶)   
...
###  <a name="tape-specific-backup-and-restore-options-transact-sql"></a><a name="TapeOptions"></a> (Transact-sql) 的磁帶特定備份和還原選項  
