...
# <a name="propertyidx-property-clientnetworkprotocolproperty-class"></a>PropertyIdx 屬性 (ClientNetworkProtocolProperty 類別)
  取得或設定屬性陣列中屬性（property）的索引值，此屬性是由[ClientNetworkProtocol 類別](../clientnetworkprotocol-class/clientnetworkprotocol-class.md)物件的[ClientNetworkProtocol) 類別 (](../clientnetworkprotocol-class/clientnetworkprotocol-class.md)的屬性（property）屬性所參考。  
