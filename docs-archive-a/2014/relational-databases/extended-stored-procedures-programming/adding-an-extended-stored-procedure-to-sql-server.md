...
>  [!INCLUDE[ssNoteDepFutureDontUse](../../includes/ssnotedepfuturedontuse-md.md)] 請改用 CLR 整合。  
 ...
 包含擴充預存程序的 DLL 會當做 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的延伸模組。 若要安裝 DLL，請將檔案複製到包含標準 DLL 檔案的目錄，如 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (C:\Program FILES\MICROSOFT SQL Server\MSSQL12.0.*x*\MSSQL\Binn 預設) 。  
