...
1.  當用戶端執行擴充預存程式時，會從用戶端應用程式 (TDS) 或簡單物件存取通訊協定 (SOAP) 格式，將要求傳送至表格式資料流程中 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 。  
