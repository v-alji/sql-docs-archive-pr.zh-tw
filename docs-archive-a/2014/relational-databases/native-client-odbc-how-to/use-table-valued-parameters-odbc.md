---
title: " (ODBC) 使用資料表值參數 |Microsoft Docs"
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "87585366"
---
# <a name="use-table-valued-parameters-odbc"></a><span data-ttu-id="1d696-102">使用資料表值參數 (ODBC)</span><span class="sxs-lookup"><span data-stu-id="1d696-102">Use Table-Valued Parameters (ODBC)</span></span>
  <span data-ttu-id="1d696-103">此範例示範如何使用資料表值參數插入多個資料列、搭配多個資料行使用資料表值參數、搭配一個伺服器的呼叫使用資料表值參數。</span><span class="sxs-lookup"><span data-stu-id="1d696-103">This sample shows how to use table-valued parameters to insert multiple rows, with multiple columns, with one call to the server.</span></span>  
  
 <span data-ttu-id="1d696-104">如需資料表值參數的詳細資訊，請參閱[ODBC&#41;&#40;的資料表值參數](../native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md)。</span><span class="sxs-lookup"><span data-stu-id="1d696-104">For more information about table-valued parameters, see [Table-Valued Parameters &#40;ODBC&#41;](../native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md).</span></span> <span data-ttu-id="1d696-105">如需使用資料表值參數的更多範例，請參閱[ODBC 資料表值參數程式設計範例](../../database-engine/dev-guide/odbc-table-valued-parameter-programming-examples.md)。</span><span class="sxs-lookup"><span data-stu-id="1d696-105">For more samples using table-valued parameters, see [ODBC Table-Valued Parameter Programming Examples](../../database-engine/dev-guide/odbc-table-valued-parameter-programming-examples.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="1d696-106">範例</span><span class="sxs-lookup"><span data-stu-id="1d696-106">Example</span></span>  
 <span data-ttu-id="1d696-107">您將需要稱為 TVPDemo 的 ODBC 資料來源。</span><span class="sxs-lookup"><span data-stu-id="1d696-107">You will need an ODBC data source called TVPDemo.</span></span> <span data-ttu-id="1d696-108">TVPDemo 的預設資料庫可以是您電腦上的任何測試資料庫。</span><span class="sxs-lookup"><span data-stu-id="1d696-108">The default database for TVPDemo can be any test database on your computer.</span></span> <span data-ttu-id="1d696-109">對於 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client，此資料來源必須以 ODBC 驅動程式為基礎。</span><span class="sxs-lookup"><span data-stu-id="1d696-109">This data source must be based on the ODBC driver for [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.</span></span>  
  
 <span data-ttu-id="1d696-110">如果您要建立並執行此範例，當做 64 位元作業系統上的 32 位元應用程式，您必須利用 %windir%\SysWOW64\odbcad32.exe，以 ODBC 管理員身分建立 ODBC 資料來源。</span><span class="sxs-lookup"><span data-stu-id="1d696-110">If you will build and run this sample as a 32-bit application on a 64-bit operating system, you must create the ODBC data source with the ODBC Administrator in %windir%\SysWOW64\odbcad32.exe.</span></span>  
  
 <span data-ttu-id="1d696-111">這個範例會連接到電腦的預設 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 執行個體。</span><span class="sxs-lookup"><span data-stu-id="1d696-111">This sample connects to your computer's default [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] instance.</span></span> <span data-ttu-id="1d696-112">若要連接到具名執行個體，請變更 ODBC 資料來源的定義，以便使用下列格式指定執行個體：server\namedinstance。</span><span class="sxs-lookup"><span data-stu-id="1d696-112">To connect to a named instance, change the definition of the ODBC data source to specify the instance using the following format: server\namedinstance.</span></span> <span data-ttu-id="1d696-113">根據預設，[!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] 會安裝至具名執行個體。</span><span class="sxs-lookup"><span data-stu-id="1d696-113">By default, [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] installs to a named instance.</span></span>  
  
 <span data-ttu-id="1d696-114">使用 odbc32.lib 和 user32.lib 編譯 (C++) 程式碼清單。</span><span class="sxs-lookup"><span data-stu-id="1d696-114">Compile the (C++) code listing with odbc32.lib and user32.lib.</span></span> <span data-ttu-id="1d696-115">請確認您的 INCLUDE 環境變數包含的目錄內含 sqlncli.h。</span><span class="sxs-lookup"><span data-stu-id="1d696-115">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
