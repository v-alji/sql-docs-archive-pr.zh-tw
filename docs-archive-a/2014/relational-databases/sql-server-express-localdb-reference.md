...
ms.locfileid: "87597053"
---
# <a name="sql-server-express-localdb-reference"></a><span data-ttu-id="27fac-102">SQL Server Express LocalDB 參考</span><span class="sxs-lookup"><span data-stu-id="27fac-102">SQL Server Express LocalDB Reference</span></span>
  <span data-ttu-id="27fac-103">本節包含有關 SQL Server Express LocalDB 的資訊：</span><span class="sxs-lookup"><span data-stu-id="27fac-103">This section contains information about the SQL Server Express LocalDB:</span></span>  
  
-   [<span data-ttu-id="27fac-104">SQL Server Express LocalDB 錯誤訊息參考</span><span class="sxs-lookup"><span data-stu-id="27fac-104">SQL Server Express LocalDB Error Message Reference</span></span>](express-localdb-error-messages/sql-server-express-localdb-reference-error-messages.md)  
  
-   [<span data-ttu-id="27fac-105">SQL Server Express LocalDB 執行個體 API 參考</span><span class="sxs-lookup"><span data-stu-id="27fac-105">SQL Server Express LocalDB Instance API Reference</span></span>](express-localdb-instance-apis/sql-server-express-localdb-reference-instance-apis.md)  
  
## <a name="code-sample"></a><span data-ttu-id="27fac-106">程式碼範例</span><span class="sxs-lookup"><span data-stu-id="27fac-106">Code Sample</span></span>  
 <span data-ttu-id="27fac-107">下列範例示範 LocalDB API。</span><span class="sxs-lookup"><span data-stu-id="27fac-107">The following sample demonstrates the LocalDB API.</span></span>  <span data-ttu-id="27fac-108">請確認電腦上已安裝 LocalDB，再執行此範例。</span><span class="sxs-lookup"><span data-stu-id="27fac-108">Make sure that LocalDB is installed on the computer before running this sample.</span></span>  <span data-ttu-id="27fac-109">您可以從 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express 的安裝程式來安裝 LocalDB。</span><span class="sxs-lookup"><span data-stu-id="27fac-109">You can install LocalDB from setup in the [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span></span>  
