...
> [!NOTE]
>  只有當合併式發行集的同步處理優化選項設定為**true**時，才會將此參數設定為**1** ， (**@keep_partition_changes** [sp_addmergepublication &#40;transact-sql&#41;](/sql/relational-databases/system-stored-procedures/sp-addmergepublication-transact-sql)) 的參數。  
