...
9. 若要將程式庫註冊為自訂衝突解決器，請在「散發者」[端執行 &#40;transact-sql&#41;sp_registercustomresolver ](/sql/relational-databases/system-stored-procedures/sp-registercustomresolver-transact-sql)。 為指定 COM 物件的易記名稱、連結 **@article_resolver** 庫的識別碼 (的 CLSID) **@resolver_clsid** ，以及的值 `false` **@is_dotnet_assembly** 。  
