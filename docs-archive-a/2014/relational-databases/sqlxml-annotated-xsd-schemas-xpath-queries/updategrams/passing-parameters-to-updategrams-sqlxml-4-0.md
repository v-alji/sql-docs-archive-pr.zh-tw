...
2.  準備 SQLXML 4.0 測試腳本 () Sqlxml4test.vbs 在中[使用 ADO 執行 sqlxml 4.0 查詢](../../sqlxml/using-ado-to-execute-sqlxml-4-0-queries.md)以執行 updategram，方法是在之後新增下列幾行 `cmd.Properties("Output Stream").Value = outStream` ：  
