...
### <a name="create-a-resource-pool-and-configure-memory"></a>建立資源集區和設定記憶體  
 ...
 請參閱[最佳做法：在 VM 環境使用記憶體內部 OLTP](../../database-engine/using-in-memory-oltp-in-a-vm-environment.md)，以了解有關在 VM 環境下作業的詳細資訊。  
