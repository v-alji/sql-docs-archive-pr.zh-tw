...
---
# <a name="retrieving-error-information"></a><span data-ttu-id="8fec7-102">擷取錯誤資訊</span><span class="sxs-lookup"><span data-stu-id="8fec7-102">Retrieving Error Information</span></span>
  <span data-ttu-id="8fec7-103">這個範例會從 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供者公開的各種錯誤介面中取得資訊。</span><span class="sxs-lookup"><span data-stu-id="8fec7-103">This example obtains information from the various error interfaces exposed by the [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB provider.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="8fec7-104">另請參閱</span><span class="sxs-lookup"><span data-stu-id="8fec7-104">See Also</span></span>  
 [<span data-ttu-id="8fec7-105">錯誤</span><span class="sxs-lookup"><span data-stu-id="8fec7-105">Errors</span></span>](errors.md)  
