...
# <a name="using-ado-with-sql-server-native-client"></a>使用 ADO 搭配 SQL Server Native Client
  為了利用中引進的新功能 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] （例如，多個 active result sets (MARS) 、查詢通知、使用者定義型別 (udt) 或新的**xml**資料型別，使用 ActiveX Data Objects (ADO) 的現有應用程式應該使用 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client OLE DB 提供者作為其資料存取提供者。  
