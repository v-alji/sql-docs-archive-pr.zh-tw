...
## <a name="in-this-section"></a>本節內容  
 ...
 討論 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 如何支援 (UDT) 的使用者定義型別，這可讓您將物件和自訂資料結構儲存在資料庫中，藉此擴充 SQL 型別系統 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 。  
 ...
 [使用快照集隔離](working-with-snapshot-isolation.md)  
