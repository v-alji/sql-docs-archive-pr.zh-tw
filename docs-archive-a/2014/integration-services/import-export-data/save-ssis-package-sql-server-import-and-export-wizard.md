...
# <a name="save-ssis-package-sql-server-import-and-export-wizard"></a>儲存 SSIS 封裝 (SQL Server 匯入和匯出精靈)
  使用 [**儲存 SSIS 封裝**] 頁面，即可命名、描述和儲存 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Integration Services ([!INCLUDE[ssIS](../../includes/ssis-md.md)]) 封裝至 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] `msdb` 資料庫或副檔名為 .dtsx 的檔案。  
