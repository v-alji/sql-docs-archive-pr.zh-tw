...
-   **在指令碼工作的指令碼中設定中斷點。** VSTA 只針對指令碼工作中的指令碼提供偵錯支援。 在指令碼工作中設定的中斷點會與封裝中設定的中斷點，以及封裝中的工作和容器整合，以便可以對所有的封裝元素進行嚴密的偵錯。  
 ...
 如需詳細資訊，請參閱 [Debugging Script](debugging-script.md)。 如需有關如何對腳本元件進行偵錯工具的建議，請參閱 [編碼和偵錯工具腳本元件] (.。/extending-packages-scripting/data-flow-script-component/coding-and-debugging-the-script-component.md.  
