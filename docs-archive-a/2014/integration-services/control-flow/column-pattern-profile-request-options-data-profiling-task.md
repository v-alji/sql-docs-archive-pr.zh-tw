...
-   **符號**根據預設，**符號**清單包含下列字元： `,.;:-"'` ~ =&/@！？ ( # A2 # A0 [] {} | # * ^% `. For example, if the symbols are "` ( # A4-' "，" (425) 123-4567 "的值已標記為 [" ( "，" 425 "，" ) "，" 123 "，"-"，" 4567 "，" ) "]。  
 ...
 **標點符號**  
 列出應該保留成為模式一部分的符號。 範例可能包括 "/" (代表日期)、":" (代表時間) 和 ‘\@’ (代表電子郵件地址)。 根據預設，**符號**清單包含下列字元： `,.;:-"'` ~ =&/@！？ ( # A2 # A0 [] {} | # * ^% '。  
