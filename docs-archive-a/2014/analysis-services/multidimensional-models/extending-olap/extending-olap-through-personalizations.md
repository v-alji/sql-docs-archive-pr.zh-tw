...
## <a name="personalized-extensions"></a>個人化的延伸模組  
 SQL Server Analysis Services 個人化延伸模組是實作外掛程式架構之概念的基礎。 Analysis Services 個人化延伸模組是現有 managed 元件架構的簡單且簡潔的修改，而且會在整個 Analysis Services 的[AdomdServer](/previous-versions/sql/sql-server-2014/ms131779(v=sql.120))物件模型、多維度運算式 (MDX) 語法和架構資料列集公開。  
