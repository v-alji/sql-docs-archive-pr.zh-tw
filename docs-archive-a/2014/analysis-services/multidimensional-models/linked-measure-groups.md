...
# <a name="linked-measure-groups"></a>連結量值群組
 ...
 Microsoft 建議原始和連結的量值群組皆位於同一部伺服器上所執行的解決方案中。 連結到遠端伺服器上的量值群組已排定在未來的版本中淘汰 (請參閱[SQL Server 2014) 中已取代的 Analysis Services 功能](../deprecated-analysis-services-features-in-sql-server-2014.md)。  
