...
4.  針對每一個指定的資料表重複以上步驟，設定以下資料行和報表屬性。 保留所有其他屬性的預設設定。  
    ...
    |月份名稱|依資料行排序|Month|  
    |Month|Hidden|是|  
    |Month Calendar|Hidden|是|  
    |Fiscal Quarter|Hidden|是|  
    |Fiscal Year|Hidden|是|  
    |Fiscal Semester|Hidden|是|  
    ...
    |------------|--------------|-----------|  
    |Product Id|Hidden|是|  
    |Product Alternate Id|預設標籤|是|  
    |Product Subcategory Id|Hidden|是|  
    |Product Start Date|資料格式|簡短日期|  
    |Product End Date|資料格式|簡短日期|  
    |Large Photo|Hidden|是|  
    ...
    |------------|--------------|-----------|  
    |Product Id|Hidden|是|  
    |Customer Id|Hidden|是|  
    |Promotion Id|Hidden|是|  
    |Currency Id|Hidden|是|  
    |Sales Territory Id|Hidden|是|  
