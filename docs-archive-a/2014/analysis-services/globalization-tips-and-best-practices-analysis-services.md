...
-   中文語言和定序因地區而異，但通常會是簡體中文或繁體中文。  
     ...
     其他區域 (例如香港特別行政區和澳門特別行政區) 也會使用繁體中文。 在香港特別行政區，還很常會看到 Chinese_Hong_Kong_Stroke_90 (在 SQL Server 2005 上) 的定序。 在澳門特別行政區，SQL Server 2008 和更新) 版本的 Chinese_Traditional_Stroke_Count_100 (會相當頻繁地使用。  
