...
-   [使用 SQL Server Management Studio (SSMS 來連接) ](#bkmk_SSMS)  
...
-   [Analysis Services 連線管理員](../../integration-services/connection-manager/analysis-services-connection-manager.md)  
